; CpS 230 Project Kernel: Stone Champion (scham978) and Melchisedek Dulcio (mdulc928)
;---------------------------------------------------
...
boot_msg	db	"CpS 230 Bootloading Lab", 13, 10
			db	"by Stone Champion (scham978) and Melchisedek Dulcio (mdulc928)", 13, 10, 0
...
.retry:
	...
	mov es, ax
	mov ah, 2
	mov al, 12 ; size of your payload in bytes divided by sector size (512)
	...
	xor bx, bx ; whatever offset you want to load
